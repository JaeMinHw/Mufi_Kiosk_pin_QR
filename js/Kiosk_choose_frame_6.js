...
function count(type) {
    ...
    if (type === 'cb_frame1') {
        ...
        sessionStorage.setItem('frame', frame_lis[0]);
        btnActive();
        ...
        filterarr.push(type);
        console.log(filterarr);
        sessionStorage.setItem('frame', frame_lis[1]);
        btnActive();
    }
...
function click_frame() {
    ...
    //location.href = "Kiosk_photo_6.html";
    location.href = "before_start_6.html";
}
